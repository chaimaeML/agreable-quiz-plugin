...
register_field_group(array (
  ...
  'fields' => array (
    array (
      'key' => $ns.'_plugin_field_button_bg_color',
      'label' => 'Button Background',
      'name' => $ns.'_plugin_settings_property_button_bg_color',
      'prefix' => '',
      'type' => 'color_picker',
      'instructions' => '',
      'required' => 0,
    ...
    array (
      'key' => $ns.'_plugin_field_button_bg_color_hover',
      'label' => 'Button Background Hover',
      'name' => $ns.'_plugin_settings_property_button_bg_color_hover',
      'prefix' => '',
      'type' => 'color_picker',
      'instructions' => '',
      'required' => 0,
    ...
    array (
      'key' => $ns.'_plugin_field_button_text_color',
      'label' => 'Button Text',
      'name' => $ns.'_plugin_settings_property_button_text_color',
      'prefix' => '',
      'type' => 'color_picker',
      'instructions' => '',
      'required' => 0,
    ...
    array (
      'key' => $ns.'_plugin_field_button_text_color_hover',
      'label' => 'Button Text Hover',
      'name' => $ns.'_plugin_settings_property_button_text_color_hover',
      'prefix' => '',
      'type' => 'color_picker',
      'instructions' => '',
      'required' => 0,
    ...
    array (
      'key' => $ns.'_plugin_field_share_bg_color',
      'label' => 'Share Background',
      'name' => $ns.'_plugin_settings_property_share_bg_color',
      'prefix' => '',
      'type' => 'color_picker',
      'instructions' => '',
      'required' => 0,
    ...
    array (
      'key' => $ns.'_plugin_field_primary_font_family',
      'label' => 'Primary Font Family',
      'name' => $ns.'_plugin_settings_property_primary_font_family',
      'prefix' => '',
      'type' => 'text',
      'instructions' => '',
      'required' => 0,
    ...
    array (
      'key' => $ns.'_plugin_field_secondary_font_family',
      'label' => 'Secondary Font Family',
      'name' => $ns.'_plugin_settings_property_secondary_font_family',
      'prefix' => '',
      'type' => 'text',
      'instructions' => '',
      'required' => 0,
    ...
    array (
      'key' => $ns.'_plugin_field_extra_css',
      'label' => 'Extra CSS',
    ...
    array (
      'key' => $ns.'_plugin_field_facebook_app_id',
